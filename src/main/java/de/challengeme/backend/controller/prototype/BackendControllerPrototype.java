...
public class BackendControllerPrototype {
	...
	@ApiOperation(value = "Gets all challenges, created by the user.", response = List.class)
	...
	@ApiOperation(value = "Creates a new challenge.", response = List.class)
	...
	//	@GetMapping("/user/{userId}/getRandomChallenge")
	//	@ApiOperation(value = "Gets a random challenge which the user has not done (failed or successful) yet.", response = Challenge.class)
	//	public Challenge get(@PathVariable(value = "userId") String userUUID, @RequestParam(value = "category", defaultValue = "") String name) {
	//		User user = userService.getUser(userUUID);
	//		Preconditions.checkNotNull(user, "No user found with UUID " + userUUID);
	//		long t = System.currentTimeMillis();
	//		Challenge challenge = challengeService.getRandomChallenge(Category.art, user);
	//		System.out.println("Took: " + String.valueOf(System.currentTimeMillis() - t));
	//		return challenge;
	//	}
}